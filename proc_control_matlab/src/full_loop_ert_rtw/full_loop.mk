...
## Generated on : Tue Feb 23 10:23:45 2021
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/full_loop_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/ros/slros/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=full_loop -DNUMST=5 -DNCSTATES=21 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/full_loop_ert_rtw/full_loop.cpp $(START_DIR)/full_loop_ert_rtw/full_loop_data.cpp $(START_DIR)/full_loop_ert_rtw/rtGetInf.cpp $(START_DIR)/full_loop_ert_rtw/rtGetNaN.cpp $(START_DIR)/full_loop_ert_rtw/rt_nonfinite.cpp $(START_DIR)/full_loop_ert_rtw/rt_zcfcn.cpp $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.cpp $(START_DIR)/full_loop_ert_rtw/slros_busmsg_conversion.cpp $(START_DIR)/full_loop_ert_rtw/slros_initialize.cpp $(MATLAB_ROOT)/toolbox/ros/slros/src/slros_generic_param.cpp
...
OBJS = full_loop.cpp.o full_loop_data.cpp.o rtGetInf.cpp.o rtGetNaN.cpp.o rt_nonfinite.cpp.o rt_zcfcn.cpp.o linuxinitialize.cpp.o slros_busmsg_conversion.cpp.o slros_initialize.cpp.o slros_generic_param.cpp.o
...
rt_zcfcn.cpp.o : $(START_DIR)/full_loop_ert_rtw/rt_zcfcn.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slros_busmsg_conversion.cpp.o : $(START_DIR)/full_loop_ert_rtw/slros_busmsg_conversion.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slros_initialize.cpp.o : $(START_DIR)/full_loop_ert_rtw/slros_initialize.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
