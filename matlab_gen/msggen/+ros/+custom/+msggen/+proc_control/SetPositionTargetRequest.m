classdef SetPositionTargetRequest < ros.Message
    %SetPositionTargetRequest MATLAB implementation of proc_control/SetPositionTargetRequest
    ...
    properties (Constant)
        MessageType = 'proc_control/SetPositionTargetRequest' % The ROS message type
    end
    ...
    methods
        function obj = SetPositionTargetRequest(msg)
            %SetPositionTargetRequest Construct the message object SetPositionTargetRequest
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'SetPositionTargetRequest', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'SetPositionTargetRequest', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'SetPositionTargetRequest', 'Z');
        ...
        function set.ROLL(obj, roll)
            ...
            validateattributes(roll, {'numeric'}, {'nonempty', 'scalar'}, 'SetPositionTargetRequest', 'ROLL');
        ...
        function set.PITCH(obj, pitch)
            ...
            validateattributes(pitch, {'numeric'}, {'nonempty', 'scalar'}, 'SetPositionTargetRequest', 'PITCH');
        ...
        function set.YAW(obj, yaw)
            ...
            validateattributes(yaw, {'numeric'}, {'nonempty', 'scalar'}, 'SetPositionTargetRequest', 'YAW');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.proc_control.SetPositionTargetRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.proc_control.SetPositionTargetRequest;
            obj.reload(strObj);
        end
    end
end
