classdef EnableControlRequest < ros.Message
    %EnableControlRequest MATLAB implementation of proc_control/EnableControlRequest
    ...
    properties (Constant)
        MessageType = 'proc_control/EnableControlRequest' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '18e3a20584eaf0b940bc485a1f16ec5a' % The MD5 Checksum of the message definition
    end
    ...
    methods
        function obj = EnableControlRequest(msg)
            %EnableControlRequest Construct the message object EnableControlRequest
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'EnableControlRequest', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'EnableControlRequest', 'Y');
        ...
        function z = get.Z(obj)
            ...
            z = int8(obj.JavaMessage.getZ);
        end
        
        function set.Z(obj, z)
            %set.Z Set the value for property Z
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'EnableControlRequest', 'Z');
        ...
        function roll = get.ROLL(obj)
            ...
            roll = int8(obj.JavaMessage.getROLL);
        end
        
        function set.ROLL(obj, roll)
            %set.ROLL Set the value for property ROLL
            validateattributes(roll, {'numeric'}, {'nonempty', 'scalar'}, 'EnableControlRequest', 'ROLL');
        ...
        function pitch = get.PITCH(obj)
            ...
            pitch = int8(obj.JavaMessage.getPITCH);
        end
        
        function set.PITCH(obj, pitch)
            %set.PITCH Set the value for property PITCH
            validateattributes(pitch, {'numeric'}, {'nonempty', 'scalar'}, 'EnableControlRequest', 'PITCH');
        ...
        function yaw = get.YAW(obj)
            ...
            yaw = int8(obj.JavaMessage.getYAW);
        end
        
        function set.YAW(obj, yaw)
            %set.YAW Set the value for property YAW
            validateattributes(yaw, {'numeric'}, {'nonempty', 'scalar'}, 'EnableControlRequest', 'YAW');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.proc_control.EnableControlRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.proc_control.EnableControlRequest;
            obj.reload(strObj);
        end
    end
end
