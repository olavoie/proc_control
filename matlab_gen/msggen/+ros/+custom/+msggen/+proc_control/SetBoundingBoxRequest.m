classdef SetBoundingBoxRequest < ros.Message
    %SetBoundingBoxRequest MATLAB implementation of proc_control/SetBoundingBoxRequest
    ...
    properties (Constant)
        MessageType = 'proc_control/SetBoundingBoxRequest' % The ROS message type
    end
    ...
    methods
        function obj = SetBoundingBoxRequest(msg)
            %SetBoundingBoxRequest Construct the message object SetBoundingBoxRequest
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'SetBoundingBoxRequest', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'SetBoundingBoxRequest', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'SetBoundingBoxRequest', 'Z');
        ...
        function set.ROLL(obj, roll)
            ...
            validateattributes(roll, {'numeric'}, {'nonempty', 'scalar'}, 'SetBoundingBoxRequest', 'ROLL');
        ...
        function set.PITCH(obj, pitch)
            ...
            validateattributes(pitch, {'numeric'}, {'nonempty', 'scalar'}, 'SetBoundingBoxRequest', 'PITCH');
        ...
        function set.YAW(obj, yaw)
            ...
            validateattributes(yaw, {'numeric'}, {'nonempty', 'scalar'}, 'SetBoundingBoxRequest', 'YAW');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.proc_control.SetBoundingBoxRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.proc_control.SetBoundingBoxRequest;
            obj.reload(strObj);
        end
    end
end
