classdef SetForces < ros.Message
    %SetForces MATLAB implementation of proc_control_matlab/SetForces
    ...
    properties (Constant)
        MessageType = 'proc_control_matlab/SetForces' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = 'a98f3d183efdc812700e2561602a6f53' % The MD5 Checksum of the message definition
    end
    ...
    methods
        function obj = SetForces(msg)
            %SetForces Construct the message object SetForces
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'SetForces', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'SetForces', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'SetForces', 'Z');
        ...
        function set.Roll(obj, roll)
            ...
            validateattributes(roll, {'numeric'}, {'nonempty', 'scalar'}, 'SetForces', 'Roll');
        ...
        function set.Pitch(obj, pitch)
            ...
            validateattributes(pitch, {'numeric'}, {'nonempty', 'scalar'}, 'SetForces', 'Pitch');
        ...
        function set.Yaw(obj, yaw)
            ...
            validateattributes(yaw, {'numeric'}, {'nonempty', 'scalar'}, 'SetForces', 'Yaw');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.proc_control_matlab.SetForces.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.proc_control_matlab.SetForces;
            obj.reload(strObj);
        end
    end
end
