classdef AddPose < ros.Message
    %AddPose MATLAB implementation of proc_control_matlab/AddPose
    ...
    properties (Constant)
        MessageType = 'proc_control_matlab/AddPose' % The ROS message type
    end
    ...
    methods
        function obj = AddPose(msg)
            %AddPose Construct the message object AddPose
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'AddPose', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'AddPose', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'AddPose', 'Z');
        ...
        function set.Roll(obj, roll)
            ...
            validateattributes(roll, {'numeric'}, {'nonempty', 'scalar'}, 'AddPose', 'Roll');
        ...
        function set.Pitch(obj, pitch)
            ...
            validateattributes(pitch, {'numeric'}, {'nonempty', 'scalar'}, 'AddPose', 'Pitch');
        ...
        function set.Yaw(obj, yaw)
            ...
            validateattributes(yaw, {'numeric'}, {'nonempty', 'scalar'}, 'AddPose', 'Yaw');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.proc_control_matlab.AddPose.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.proc_control_matlab.AddPose;
            obj.reload(strObj);
        end
    end
end
