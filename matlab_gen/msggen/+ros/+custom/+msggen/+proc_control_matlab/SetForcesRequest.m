classdef SetForcesRequest < ros.Message
    %SetForcesRequest MATLAB implementation of proc_control_matlab/SetForcesRequest
    ...
    properties (Constant)
        MessageType = 'proc_control_matlab/SetForcesRequest' % The ROS message type
    end
    ...
    methods
        function obj = SetForcesRequest(msg)
            %SetForcesRequest Construct the message object SetForcesRequest
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'SetForcesRequest', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'SetForcesRequest', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'SetForcesRequest', 'Z');
        ...
        function set.Roll(obj, roll)
            ...
            validateattributes(roll, {'numeric'}, {'nonempty', 'scalar'}, 'SetForcesRequest', 'Roll');
        ...
        function set.Pitch(obj, pitch)
            ...
            validateattributes(pitch, {'numeric'}, {'nonempty', 'scalar'}, 'SetForcesRequest', 'Pitch');
        ...
        function set.Yaw(obj, yaw)
            ...
            validateattributes(yaw, {'numeric'}, {'nonempty', 'scalar'}, 'SetForcesRequest', 'Yaw');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.proc_control_matlab.SetForcesRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.proc_control_matlab.SetForcesRequest;
            obj.reload(strObj);
        end
    end
end
